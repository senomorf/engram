...
class MediaWriteBack(
    ...
    /**
     * Maintenance for reused-id backups kept aside (issue #92). Separate from the write
     * transaction (issue #129) but sharing this class's mutex, so administration can never
     * interleave with a write or a recovery pass over the same directory.
     */
    val shelved: ShelvedBackups = ShelvedBackups(journal, mutex, io)
